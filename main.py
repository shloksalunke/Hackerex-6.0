...
# --- Application Lifespan for Startup Optimization (for Render) ---
@asynccontextmanager
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logging.error(f"🚨 WARNING: Failed to pre-cache known document. System will still work but the first request may be slow. Error: {e}")
